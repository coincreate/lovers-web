    ...
    <div class="container-fluid">
        ...
        <div class="navbar-header active">
            ...
            <a class="navbar-brand visibility-hidden" href="/" >
                <img alt="Brand" src="/public/img/logo_final.svg" height="16">
            </a>
...
<div class="jumbotron">
    <div class="container">
          <div class="collapse-group">
            <a href="/" class="nolink"><h1><img src="/public/img/logo_final.svg" width="110" height="60" id="biglogo" class="biglogo"> 三生三世爱你 </h1></a>
            <p class="submessage"><a href="#"  class="nolink" id="more">永久保存，代代相传<small><span id="caret">&nbsp;&nbsp;<i class="fa fa-caret-down"></i></span></small></a></p>
            <div class="collapse">
...
<div class="container">
    ...
    <div class="mymedia col-md-6 panel panel-default margins" >
      <div class="">
          <h5 style="color:gray">{{item.timeStr}}</h5>
          <p class="maintext" id="maintext">{{item.letter}}</p>
          <p class="maintext" id="translation" style="display: none;"></p>
          <h4>
              &nbsp;&nbsp;&nbsp;
              <div class="dropdown" style="display: inline-block;">
                  <a id="externalMenu" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" title="Proof" class="mytooltip" data-placement="bottom" ><i class="fa fa-external-link grayfont"></i></a>
                  <ul class="dropdown-menu" aria-labelledby="externalMenu">
                      <li><a href="https://eospark.com/MainNet/tx/{{item.txHash}}">eospark.com</a></li>
                      <li><a href="https://eosflare.io/tx/{{item.txHash}}">eosflare.io</a></li>
                  </ul>
              </div>
...
<div class="modal fade" id="embedMessage" role="dialog">
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">Embed this message</h4>
                    </div>
                    <div class="modal-body">
                        <input class="form-control" value="&lt;a style=&quot;text-decoration: none !important;&quot; href=&quot;https://eternitywall.it/m/7d52d025&quot;&gt;&lt;div style=&quot;max-width:500px;padding-left:10px;padding-right:10px;border:1px;border-color:#ddd;margin-bottom:20px;background-color:#fff;border:1px solid #ddd;border-radius: 4px;-webkit-box-shadow: 0 1px 1px rgba(0,0,0,.05);box-shadow: 0 1px 1px rgba(0,0,0,.05);&quot;&gt;&lt;p style=&quot;color:gray;margin-top:10px;&quot;&gt;2018年8月15日 下午6:23&lt;/p&gt;&lt;p style=&quot;font-size:x-large&quot;&gt;probablement ses, p.e. eutel sat&lt;/p&gt;&lt;/div&gt;&lt;/a&gt;" id="embedMessageInput">
                    </div>
        ...
        <div class="modal-dialog vertical-align-center">
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                        <h4 class="modal-title">Message ranking</h4>
                    </div>
                    <div class="modal-body">
                        <h1 class="text-center">0.000 <small>bottom</small></h1><br>This page has been viewed <strong>0</strong> times of which <strong>0</strong> in the last seven days. 
                    </div>
                    <div class="modal-footer">
                        <small>* fully refreshed daily</small>
                        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                    </div>
                </div>
        ...
        <div class="modal-dialog vertical-align-center">
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <input class="form-control" value="/id/{{item.id}}" id="copyLinkInput">
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                    </div>
...
<!-- WHAT'S? MODAL -->
<div class="modal fade" id="whats" role="dialog">
    <div class="vertical-alignment-helper">
        <div class="modal-dialog vertical-align-center">
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                        <h4 class="modal-title">What's?</h4>
                    </div>
                    <div class="modal-body">
                        <p>Web sites reachable from <i class="fa fa-external-link"></i> are third party sources where you can find the same message written on the wall. This proves the message is embedded in the bitcoin blockchain.<br>For posterity.</p>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                    </div>
                    ...
                    <form action="/dispatch" method="post">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="hidden" class="form-control" id="reply" name="reply"
                                       value="18MUGh4Geu6sbMwhCazCuzumUf67ZK6Szk"
                        ...
                        <div class="modal-footer">
                            <div style="float:right;"><span id="totalchars"></span> &nbsp;<button type="submit" class="btn btn-primary btn-lg"><i class="fa fa-paper-plane"></i> Send</button></div>
                        </div>
                    </form>
                </div>
            </div>
...
<div class="modal fade" id="refLinkPopup" role="dialog">
    <div class="vertical-alignment-helper">
        <div class="modal-dialog vertical-align-center">
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">What's this box?</h4>
                    </div>
                    <div class="modal-body">
                        <p>This is a personalized message included in the link that brought you here, it isn't stored in the blockchain like the main message and neither in the 三生三世 servers.</p>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                    </div>
