    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="active"><a href="/about">帮助</a></li>
...
<div class="container">
    <section id="disclaimer">
        <br><br><h2>第三方声明</h2>
        <p>我们不生产内容，我们只是内容的搬运工。这里的内容是由访客和其他第三方生成的。这些内容的原本是存储在区块链上的，它是一种去中心化的存储设施，所以，我们
        没有任何能力可以控制这些内容本身，也无法控制这些内容存储在哪里，更无法删除区块链上原始数据，本站只是用来显示内容而已。因此本站的任何言论、观点、消息以及声明等都是第三方的个人或者机构独立发布和创作的，Ta们各自拥有自己的
        言论、观点、消息以及声明的所有权，我们不拥有Ta们发布的任何内容，也不对Ta们发布的任何内容负责。
        我们也无法保证这些信息的准确性，完整性，真实性，诚实性，准确性，真实性和礼貌性。
        <br><br>
        因为内容不受我们控制，本网站可能会无意中链接到淫秽，猥亵，毒品，色情，恐吓的内容，对此此类内容，本站一经发现，即会将其过滤，欢迎举报。
    </section>
